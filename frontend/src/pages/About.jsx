    ...
    <div>
      ...
      <div className='flex flex-col my-10 md:flex-row gap-12 items-center'>
        ...
        <div className='text-gray-600 tracking-wide flex flex-col gap-6 md:2/4 text-sm'>
          <p>Welcome to DocOnTime, your trusted partner in managing your healthcare needs conveniently and efficiently. At DocOnTime, we understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records.</p>
          <p>DocOnTime is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether you're booking your first appointment or managing ongoing care, DocOnTime is here to support you every step of the way.</p>
          <b className='text-gray-800'>Our Vision</b>
          <p>Our vision at DocOnTime is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.</p>
        </div>
      </div>
      <div>
